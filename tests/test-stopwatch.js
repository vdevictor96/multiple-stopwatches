...
(async () => {
  ...
  const initialTime = await page.locator('.time button').first().textContent();
  ...
  const timeAfter3Sec = await page.locator('.time button').first().textContent();
  ...
  // Step 9: Test parseTimeToSeconds function
